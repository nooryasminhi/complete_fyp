...
// Fetch current QR code image
$qr_query = "SELECT qr_code FROM settings WHERE id = 1";
$qr_result = $db->query($qr_query);
$qr_row = $qr_result->fetch_assoc();
$qr_image = $qr_row ? 'admin/' . $qr_row['qr_code'] : '/image/qr.jpg'; 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['qr_code']) && $_FILES['qr_code']['error'] == 0) {
        ...
        move_uploaded_file($_FILES["qr_code"]["tmp_name"], $qr_file);

        // Update QR code path in the database
        $qr_code_path = basename($_FILES["qr_code"]["name"]);
        $update_qr_query = "UPDATE settings SET qr_code = '$qr_code_path' WHERE id = 1";
        $db->query($update_qr_query);
    }
    ...
    <div class="donation-form-container">
        <div class="donation-form">
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="project">Which project do you want to donate to?:</label>
                ...
                <div class="form-group">
                    <a href="<?php echo $qr_image; ?>" target="_blank">View QR for Payment</a>
                </div>
                <div class="form-group">
